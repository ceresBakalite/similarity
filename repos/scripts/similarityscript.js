...
(function()
{
    ...
    {
        if (!cookies.get('hd')) cookies.set('hd', 'block', { 'max-age': 7200, 'samesite': 'none', 'secure': 'secure' });
        if (!cookies.get('pn')) cookies.set('pn', 'disabled', { 'max-age': 7200, 'samesite': 'none', 'secure': 'secure' });
    ...
    function resetDisplayState(attribute)
    {
        ...
        cookies.set('hd', attribute, { 'max-age': 7200, 'samesite': 'none', 'secure': 'secure' });
    }
    ...
    function setPinState(el, attribute)
    {
        ...
        cookies.set('pn', attribute, { 'max-age': 7200, 'samesite': 'none', 'secure': 'secure' });
    }
