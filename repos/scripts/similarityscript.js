...
function refreshMarkdown_Repos()
{
  ...
  document.getElementByTagName("img")[0].setAttribute("src", "https://ceresbakalite.github.io/similarity/images/NAVSimilarityLogoRepos.png?" + getRandomInteger(10000,1000000));
}
