        ...
        function getImageArray()
        {
            ...
            function imageArray()
            {
                ...
                function getAttributes()
                {
                    ...
                    resource.attributes.ImageListMarkup = 'Image list markup ' + ((resource.attributes.ProgenitorSource) ? 'sourced from callback list' : 'sourced from document body list') + ' [' + slideview.HTMLSlideViewElement + ']' + newline;
