    ...
    function initiateSlideView()
    {
        ...
        function getImageArray()
        {
            ...
            function getSlideviewAttributes()
            {
                ...
                resource.attribute.ListContainerMarkup = 'Image list markup ' + ((resource.attribute.ProgenitorSource) ? 'delivered as promised by connectedCallback' : 'sourced from document body') + ' [' + slideview.HTMLSlideViewElement + ']:' + newline;
