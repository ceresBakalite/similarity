...
(function(slideview)
{
    ...
    function resource(type, item, str)
    {
        ...
        {
            const lookup = {
                [manifest.CSVObjectProperties]: 'The Ceres Slide Viewer [' + slideview.HTMLSlideViewElement + '] object properties after initialisation: ' + (Object.keys(csv) + ' ' + Object.keys(csv).value).join(", "),
