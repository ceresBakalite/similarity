...
(function(slideview)
{
    ...
    slideview.slideViewer = function() { setTimeout(initiateSlideViewer, slideview.delayRender); };
    ...
    function activateSlideViewer()
    {
        ...
        setTimeout(function() { setSlideViewerDisplay('block'); }, slideview.delayRender);
    }
